...
VALUES 
    -- Établissement 1
    (1, 1), (2, 1), (3, 1), (4, 1), (122, 1),
    -- Établissement 2
    (5, 2), (6, 2),
    -- Établissement 6
    (7, 6), (21, 6), (22, 6), (23, 6), (24, 6), (30, 6), (32, 6),
    -- Établissement 8
    (8, 8), (119, 8), (120, 8), (121, 8),
    -- Établissement 3
    (9, 3), (10, 3), (11, 3), (12, 3),
    -- Établissement 4
    (13, 4), (70, 4),
    ...
    -- Établissement 9
    (82, 9), (86, 9), (88, 9), (91, 9), (96, 9),
    -- Établissement 10
    (38, 10), (39, 10), (40, 10), (41, 10),
    -- Établissement 11
    (15, 11), (43, 11), (45, 11), (46, 11),
    -- Établissement 12
    (44, 12), (47, 12), (48, 12),
    -- Établissement 13
    (49, 13), (50, 13), (57, 13),
    -- Établissement 14
    (51, 14), (52, 14), (53, 14), (54, 14), (55, 14), (56, 14), (58, 14),
    -- Établissement 15
    (16, 15), (35, 15), (61, 15), (64, 15), (69, 15),
    -- Établissement 16
    (62, 16), (63, 16), (68, 16),
    -- Établissement 17
    (37, 17), (65, 17), (66, 17), (67, 17), (93, 17), (95, 17), (97, 17), (99, 17),
    -- Établissement 18
    (42, 18), (71, 18), (72, 18),
    -- Établissement 19
    (79, 19), (80, 19),
    -- Établissement 20
    (31, 20), (73, 20), (74, 20), (75, 20), (76, 20), (77, 20), (78, 20),
    -- Établissement 21
    (1, 21), (2, 21), (3, 21), (4, 21), (122, 21),
    -- Établissement 22
    (33, 22), (60, 22), (100, 22),
    -- Établissement 24
    ...
    (59, 26), (98, 26),
    -- Établissement 27
    (107, 27), (108, 27), (109, 27),
    -- Établissement 28
    (81, 28), (110, 28),
    -- Établissement 29
    (1, 29), (2, 29), (3, 29), (4, 29), (122, 29),
    -- Établissement 30
    (89, 30), (90, 30), (92, 30), (94, 30),
    -- Établissement 31
    ...
    (114, 33), (115, 33),
    -- Établissement 34
    (83, 34), (84, 34), (85, 34), (87, 34),
    -- Établissement 35
    (116, 35), (117, 35), (118, 35),
    -- Établissement 36
    (123, 36), (124, 36), (125, 36), (126, 36),
    -- Établissement 37
    (127, 37), (128, 37), (129, 37), (130, 37),
    -- Établissement 38
    (131, 38), (132, 38), (133, 38),
    -- Établissement 39
    (134, 39), (135, 39), (136, 39),
    -- Établissement 40
    (137, 40), (138, 40), (139, 40),
    -- Établissement 41
    (140, 41), (141, 41), (142, 41),
    -- Établissement 42
    (143, 42), (144, 42), (145, 42), (146, 42),
    -- Établissement 43
    (147, 43), (148, 43), (149, 43),
    -- Établissement 44
    (150, 44), (151, 44), (152, 44),
    -- Établissement 45
    (153, 45), (154, 45), (155, 45);
