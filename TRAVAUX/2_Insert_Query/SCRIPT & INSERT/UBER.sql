...
/* Date de création :  20/11/2024 15:20:22                      */
/*==============================================================*/
...
CREATE TABLE PLANNING_RESERVATION (
   IDPALANNING INT4 NOT NULL,
   IDCLIENT INT4 NOT NULL,
   CONSTRAINT PK_PLANNING_RESERVATION PRIMARY KEY (IDPALANNING)
);
...
-- PRIXCOMMANDE ajusté à 120.00 (supérieur à 110.75)
(
   4,
   4,
   4,
...
(
   ...
   'En attente',
   3.8,
   'Produit correct mais pas assez rapide',
   4.0,
   20
),
(
...
(
   ...
   'En attente',
   3.9,
   'En attente mais service convenable',
   1.0,
   10
),
(
   ...
   'Terminée',
   4.6,
   'Livraison ok, mais un peu trop long',
   6.0,
   20
),
(
   ...
   'En cours',
   4.4,
   'Bon service, mais je m’attendais à mieux',
   4.0,
   11
),
(
...
(
   ...
   'Annulée',
   NULL,
   'Annulation en raison d’un imprévu',
   0.0,
   12
),
(
...
(
   ...
   'Terminée',
   4.5,
   'Bien mais pourrait être plus rapide',
   9.0,
   22
),
(
...
(
   ...
   'Annulée',
   NULL,
   'Annulation pour problème de paiement',
   0.0,
   10
),
(
...
(
   ...
   'Annulée',
   NULL,
   'Annulation due à un problème de disponibilité',
   0.0,
   12
),
(
   ...
   'En cours',
   4.6,
   'Livraison rapide, mais coûteuse',
   7.5,
   18
),
(
...
(
   ...
   'En attente',
   4.4,
   'En attente mais service acceptable',
   6.5,
   15
),
(
...
(
   2,
   'UberXL',
   'un Voyage standar mais plus grand',
   'UberXL.jpg'
),
(
   3,
...
(
   6,
   'UberPet',
   'pour un voyage qui accepte absolument les animaux',
   'UberPet.jpg'
),
(
   7,
