...
@section('content')
    <div class="container mt-5">
        <h1 class="text-center mb-4">Inscription Passager</h1>
        ...
        <form action="{{ route('register') }}" method="POST" class="form-register d-flex flex-column justify-content-center">
            ...
            <h5 class="mb-3">Informations sur l'entreprise (optionnel) :</h5>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="siretentreprise" id="siretentreprise" class="form-control" pattern="^\d{14}$"
                    title="SIRET valide (14 chiffres)" placeholder="12345678901234" maxlength="14" inputmode="numeric"
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="adresse" id="adresse" class="form-control" maxlength="100"
                    placeholder="Adresse complète">
            </div>

            <div class="form-group mb-3">
                <label for="ville">Ville de l'entreprise :</label>
                <input type="text" name="ville" id="ville" class="form-control" maxlength="50"
                    placeholder="Ville">
            </div>

            <div class="form-group mb-3">
                <label for="codepostal">Code Postal de l'entreprise :</label>
                <input type="text" name="codepostal" id="codepostal" class="form-control" pattern="^\d{5}$"
                    title="Code postal valide (5 chiffres)" placeholder="75000" maxlength="5"
                    oninput="validateNumericInput(this)">
                <small>Format : 5 chiffres (exemple : 75000).</small>
            </div>

            <h5 class="mb-3">Adresse personnelle :</h5>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                <label for="codepostalperso">Code Postal :</label>
                <input type="text" name="codepostalperso" id="codepostalperso" class="form-control" required pattern="^\d{5}$"
                    title="Code postal valide (5 chiffres)" placeholder="75000" maxlength="5"
                    oninput="validateNumericInput(this)">
                <small>Format : 5 chiffres (exemple : 75000).</small>
            </div>
