                            ...
                            <td>
                                @if ($entretien->status !== 'Terminée')
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('entretiens.planifierForm', $entretien->identretien) }}" class="btn-entretien text-decoration-none">Planifier</a>
                                    </div>
                                    @endif


                                    @if ($entretien->status === 'Planifié')
                                        <form class="d-flex justify-content-center" action="{{ route('entretiens.resultat', ['id' => $entretien->identretien]) }}"
