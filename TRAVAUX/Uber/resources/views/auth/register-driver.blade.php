        ...
        <form action="{{ route('register') }}" method="POST" class="form-register">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="codepostalEntreprise" id="codepostalEntreprise" class="form-control" required
            ...
            <button type="submit" class="btn-login mt-2">S'inscrire</button>
        </form>
    </div>
@endsection
