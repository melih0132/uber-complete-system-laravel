                    ...
                    <div class="p-4">
                        ...
                        <div id="content-confidentialite" class="content-section">
                            ...
                            @if (in_array($role, ['client', 'coursier', 'livreur', 'responsable', 'restaurateur']))
                                ...
                                <div class="row">
                                    <p class="ml-3">Ci-dessous les informations personnelles stockées :</p>
                                    <div class="col-6">
                                    ...
                                    @if (in_array($role, ['client', 'coursier', 'livreur']))
                                        <div class="col-6">
                                            <p><strong>Date de naissance :</strong>
                                                {{ \Carbon\Carbon::parse($user->datenaissance)->format('d/m/Y') }}</p>
                                        </div>
                                    @endif
                                </div>
                                <div class="mt-2">
                                    <form action="{{ route('user.delete') }}" method="POST"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn-compte text-decoration-none">
                                            Supprimer le compte
                                        </button>
                                    </form>
                                </div>
