                ...
                @if ($user && $user['role'] === 'coursier')
                    ...
                    <li class="pr-1">
                        <a data-baseweb="button" aria-label="Voir les détails d'entretien"
                            href="{{ route('coursier.entretien') }}" target="_self" class="header-links">Entretien
                            Uber</a>
                    </li>
                    <li>
                        <a href="{{ route('conducteurs.demandes', $user['id']) }}" class="header-links">Demandes de
                            modifications sur mes véhicules</a>
                    </li>
                @endif
                ...
                @if ($user && $user['role'] === 'logistique')
                    ...
                    <li class="pr-1">
                        <a data-baseweb="button" aria-label="Gérer les modifications"
                            ...
                            class="header-links">Modifications</a>
                    </li>
                @endif
                ...
                @if ($user)
                    ...
                    <li>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button class="a-register" type="submit">Déconnexion</button>
                        </form>
                    </li>
                @else
                    <li class="pr-1">
