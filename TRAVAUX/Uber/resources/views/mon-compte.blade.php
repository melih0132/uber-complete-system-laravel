                ...
                <div class="col-md-9">
                    <div class="p-4">
                        ...
                        <div id="content-informations" class="content-section active">
                            ...
                            <!-- Account Information -->
                            <h2 class="h4 mb-3">Informations sur le compte</h2>
                            <div class="row">
                                ...
                                @endif
                                <div class="col-md-6 mb-3">
                                    <p><strong>Rôle :</strong> {{ $role === 'responsable' ? 'Responsable d\'Enseigne' : ucfirst($role) }}</p>
                                </div>
                            </div>
                        ...
                        @if ($role === 'client')
                            ...
                            <div id="content-lieux-favoris" class="content-section">
                                ...
                                <form action="{{ route('account.favorites.add') }}" method="POST" class="mb-4">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <input type="text" name="nomlieu" class="form-control" placeholder="Nom du lieu (ex : Maison)" required>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text" name="libelleadresse" class="form-control" placeholder="Adresse complète" required>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="list-group">
                                        @foreach ($favorites as $favorite)
                                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                                ...
                                                <form action="{{ route('account.favorites.delete', $favorite->idlieufavori) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            <div id="content-historique-courses" class="content-section">
                                ...
                                @if ($courses->isEmpty())
                                    <div class="alert alert-info">Votre historique de courses est vide pour le moment.</div>
                                @else
                                            ...
                                            <tbody>
                                                @foreach ($courses as $course)
                                                    <tr>
                                                        ...
                                                        <td>{{ $course->heurecourse }}</td>
                                                        <td>{{ number_format($course->prixcourse, 2) }} €</td>
                                                        <td>
                                                            <span class="badge bg-{{ $course->statutcourse === 'terminée' ? 'success' : 'primary' }}">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                @foreach ($vehicules as $vehicule)
                                                    <tr>
                                                        <td>{{ $vehicule->marque }} {{ $vehicule->modele }} - {{ $vehicule->couleur }}</td>
                                                        <td>{{ $vehicule->immatriculation }}</td>
                                                        <td>
                                                            <span class="badge bg-{{ $vehicule->statusprocessuslogistique === 'Validé' ? 'success' : 'danger' }}">
                            ...
                            <div id="content-entretien" class="content-section">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p><strong>Date :</strong> {{ $entretien->dateentretien ? $entretien->dateentretien->format('d/m/Y H:i') : 'N/A' }}</p>
                                                <p><strong>Statut :</strong> {{ ucfirst($entretien->status) }}</p>
                                            </div>
                                            <div class="col-md-6">
                                                <p><strong>Résultat :</strong> {{ $entretien->resultat ?? 'Non défini' }}</p>
                                                @if ($entretien->resultat === 'Retenu' && $entretien->rdvlogistiquedate && $entretien->rdvlogistiquelieu)
                                                    ...
                                                    <ul class="list-unstyled ms-3">
                                                        <li>Date : {{ $entretien->rdvlogistiquedate->format('d/m/Y H:i') }}</li>
