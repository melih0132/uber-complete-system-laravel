...
// Service Logistique
Route::get('/logistique/vehicules', [LogistiqueController::class, 'index'])->name('logistique.vehicules');

Route::post('/logistique/vehicules/valider/{id}', [LogistiqueController::class, 'valider'])->name('logistique.vehicules.valider');
Route::post('/logistique/vehicules/refuser/{id}', [LogistiqueController::class, 'refuser'])->name('logistique.vehicules.refuser');
...
Route::post('/modifications/supprimerToutes', [LogistiqueController::class, 'supprimerToutesLesModifications'])->name('modifications.supprimerToutes');
