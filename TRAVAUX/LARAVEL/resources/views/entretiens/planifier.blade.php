        ...
        <div class="div-planifier d-flex flex-column justify-content-center align-content-center my-auto">
            ...
            <form action="{{ route('entretiens.planifier', $entretien->identretien) }}" method="POST">
                ...
                <div>
                    ...
                    <input type="text" name="coursier" id="coursier" class="form-control w-50"
                ...
                <div>
                    ...
                    <input type="datetime-local" name="dateentretien" id="dateentretien" class="form-control w-50"
                        required>
                </div>
