        ...
        <div class="div-planifier p-4">
            ...
            @if ($entretien->resultat === 'Retenu')
                ...
                @if ($entretien->rdvlogistiquedate && $entretien->rdvlogistiquelieu)
                    <p class="p-coursier text-center">Un rendez-vous avec le service logistique a été programmé afin de finaliser votre intégration.</p>
                    <p class="p-coursier">Voici les détails de l'entretien :</p>
                    <div class="mx-3">
                    <strong>Date du rendez-vous :</strong> {{ \Carbon\Carbon::parse($entretien->rdvlogistiquedate)->format('d/m/Y H:i') }}<br>
                    <strong>Lieu :</strong> {{ $entretien->rdvlogistiquelieu }}
                    </div>
                    <p class="p-coursier text-center my-4">Veuillez vous rendre à l'adresse indiquée à la date et à l'heure spécifiées pour compléter votre inscription et recevoir votre équipement.</p>
                @else
            ...
            @else
                ...
                <p class="p-coursier text-center"> Vous serez informé de la décision finale après l'examen de votre entretien.</p>
            @endif
