...
<section class="my-5">
    ...
    <div class="container">
        ...
        <img class="img-fluid my-5" src="{{ asset('img/guide-ubereat/accueilubereat.png') }}">
        <img class="img-fluid my-2 d-flex justify-content-center" src="{{ asset('img/guide-ubereat/menuubereat.png') }}">
        ...
        <hr/>
        <h2 class="text-decoration-underline mt-5 mb-4">Etablissement</h2>
