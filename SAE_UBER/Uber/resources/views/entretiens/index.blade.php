                    ...
                    @forelse($entretiens as $entretien)
                        <tr>
                            ...
                            <td>
                                ...
                                {{-- Action: Supprimer --}}
                                <form action="{{ route('entretiens.supprimer', $entretien->identretien) }}" method="POST"
                            ...
                            <td>
                                ...
                                @if ($entretien->status === 'Terminée')
                                    <form action="{{ route('entretiens.validerCoursier', $entretien->coursier->idcoursier ?? null) }}"
                                        method="POST" style="display:inline;">
                                        @csrf
                                        <button type="submit" class="btn btn-success btn-sm">Valider le coursier</button>
                                    </form>
                                    <form action="{{ route('entretiens.refuserCoursier', $entretien->coursier->idcoursier ?? null) }}"
                                        method="POST" style="display:inline;">
                                        @csrf
